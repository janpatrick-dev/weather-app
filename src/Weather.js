    ...
    <div className="weather">
      <div className="weather__left">    
        <div className="weather__left-content">
          ...
          <img src="http://openweathermap.org/img/wn/11d@2x.png" className="weather__temp-icon" />
        </div>
      </div>
          ...
          <div className="weather__details">
            ...
            <div className="weather__details--content">
              ...
              <div className="weather__details--text-group">
                ...
                <p className="weather__details--value">{`${Math.round(weatherDetails.main.temp_max)}`}&deg;</p>
              </div>
              <div className="weather__details--text-group">
